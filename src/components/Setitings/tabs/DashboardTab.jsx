    ...
    <div className="space-y-6 animate-fadeIn text-left">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="p-4 bg-stone-950 border border-stone-900 rounded-2xl flex flex-col gap-1">
          ...
          <span className="text-2xl font-bold text-white">{localProjects?.length || 0}</span>
        ...
        <div className="p-4 bg-stone-950 border border-stone-900 rounded-2xl flex flex-col gap-1">
          ...
          <span className="text-2xl font-bold text-white">{localCertifications?.length || 0}</span>
        ...
        <div className="p-4 bg-stone-950 border border-stone-900 rounded-2xl flex flex-col gap-1">
          ...
          <span className="text-2xl font-bold text-white">{localSkills?.length || 0}</span>
        ...
        <div className="p-4 bg-stone-950 border border-stone-900 rounded-2xl flex flex-col gap-1">
          ...
          <span className="text-2xl font-bold text-white">{localTimelineData?.length || 0}</span>
      ...
      <TabCardWrapper title="Portfolio Section Visibility (SaaS Section Toggles)">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
          {["Home", "About", "Services", "Skills", "Projects", "Certification", "Journey", "Contact"]
            .filter((sec) => !(sec === "Journey" && ["template-2", "template-3", "template-5", "template-6"].includes(selectedTemplate)))
            .map((sectionName) => {
