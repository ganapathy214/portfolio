            ...
            return (
              <div key={idx} className="flex flex-col gap-2 bg-stone-950 border border-stone-900 rounded-2xl p-3">
                ...
                <input
                  ...
                  placeholder="e.g. 6+"
                  className="bg-stone-900/50 border border-stone-850 focus:border-primary outline-none text-sm font-bold rounded-lg px-3 py-1.5 text-center transition-all focus:ring-1 focus:ring-primary/20"
